...
const Detail = () => {
  ...
  <div>
    <section className='h-[20vh] relative'>
      <img className='object-cover h-full w-full' src={baseImgUrl + movie.backdrop_path} alt="" />
      ...
      <div>
        ...
        <p>Bütçe:
          <span className='text-green-500 ms-2' >
            ...
            {movie.budget === 0 ? "---" : "$"+ millify(movie.budget)}
          </span>
        </p>

        <p>
          Hasılat:
          <span  className='text-green-500  ms-2'>{movie.revenue === 0 ? "---" : "$" + millify(movie.revenue)}</span>
        </p>
      </div>
